...
{
    [TestClass]
    public class IsSubstringTesting
    {
        ...
        public void Init()
        {
            substringMethod = myTestMethods.IsSubstring;
        }
        ...
        [TestMethod]
        //Ensure case mismatch substring is not found
        public void FindInTarget_FailCase_Test()
        {
            //Arrange
            string find = "Steven";
            string target = "stevenbrown";
